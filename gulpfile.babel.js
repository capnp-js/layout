...
function browserRollup() {
  return rollup({
    ...
    bundle.write({
      file: "browser/capnp-js-layout.js",
      format: "umd",
      name: "capnpJsLayout",
      sourcemap: true,
      globals: {
...
function browserUglify() {
  return new Promise((resolve, reject) => {
    fs.readFile("browser/capnp-js-layout.js.map", (err, map) => {
      if (err) {
        reject(err);
      } else {
        const ugly = gulp.src("browser/capnp-js-layout.js")
          .pipe(uglify({
            sourceMap: {
              content: map.toString(),
              url: "capnp-js-layout.js.map",
            },
          }))
